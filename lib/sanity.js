...
const projectId = process.env.NEXT_PUBLIC_SANITY_PROJECT_ID || '37zqpgoi'
...
if (!projectId || projectId === 'your_project_id_here' || projectId.trim() === '') {
  console.warn('⚠️ Using fallback project ID: 37zqpgoi')
  finalProjectId = '37zqpgoi'
} else {
  console.log('✅ Using Sanity project ID:', finalProjectId)
}
